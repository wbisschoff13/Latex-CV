...
\includegraphics[width=0.65\columnwidth]{roundselfportrait.jpg}\\[\baselineskip] % Your photo
\small % Smaller font size
Werner Bisschoff \\ % Your name
\url{wbisschoff13@gmail.com} \\ % Your email address
%\url{http://za.linkedin.com/in/wbisschoff13} \\ % Your URL
071~826~2066 \\ % Your phone number
\Sep % Some whitespace
\textbf{Address} \\
15 Storm Street \\ % Address 1
Potchefstroom \\ % Address 2
North West \\ % Address 3
...
\cvheading{Werner Bisschoff} % Large heading - your name

\cvsubheading{Computer and Electronic Engineering Student} % Subheading - your occupation/specialization
